...
private fun ensureSurfaceTexture(id: String): SurfaceTexture? {
    ...
    private fun deferredShaderInit(vertexShader: Int) {
        ...
        shaderResourceMap["shader_nanoleaf"] = R.raw.shader_nanoleaf_v2
        shaderResourceMap["shader_nanoleaf_v4"] = R.raw.shader_nanoleaf_v4
    ...
    private fun renderSlotFlat(slot: EffectSlot, surface: MappingSurface) {
        ...
        if (slot.sourceType == SourceType.VIDEO) {
            ...
            if (shaderId == "shader_nanoleaf" || shaderId == "shader_nanoleaf_v4") {
                ...
                if (shaderId == "shader_nanoleaf_v4") {
                    // Spatial Layout Injection
                    val panelCount = slot.shaderParameters["u_panelCount"]?.toInt() ?: 16
